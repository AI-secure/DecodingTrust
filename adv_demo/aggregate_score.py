...
if __name__ == "__main__":
    ...
    parser.add_argument('--root_data_path',default="../data/adv_demo", type=str)
    parser.add_argument('--root_cache_path',default="../cache/adv_demo", type=str)
    ...
    for model in models:
        ...
        final[model]["adv_demo"] = np.mean(lis)
        print(model,  round(final[model]["adv_demo"]*100, 2))
